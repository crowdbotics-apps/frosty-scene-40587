"""
Django settings for frosty_scene_40587 project.
...
ROOT_URLCONF = 'frosty_scene_40587.urls'
...
WSGI_APPLICATION = 'frosty_scene_40587.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_scene_40587 API",
    "DESCRIPTION": "API documentation for frosty_scene_40587 App",
    "VERSION": "v1",
}
